...
cp /opt/playground/playground/.vagrant_cache/pypy-$PYPY_VERSION-linux64.tar.bz2 $HOME || true
if [[ -e $HOME/pypy-$PYPY_VERSION-linux64.tar.bz2 ]]; then
  ...
  wget -O - http://7xi756.com1.z0.glb.clouddn.com/pypy-$PYPY_VERSION-linux64.tar.bz2 |tar -xjf -
fi
